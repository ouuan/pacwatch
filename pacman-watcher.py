...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog=__prog__,
        description=f'{__prog__} is a utility which helps you watch important package updates in the pacman package manager. Source code at https://github.com/ouuan/pacman-watcher.')
